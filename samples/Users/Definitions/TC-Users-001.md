...
| 04       | Contains Alice          | Action=CheckContent Path=$[?@.name=="Alice"].name Value=Alice        | Content contains Alice | -             |
| 05       | Retain ID of Alice      | Action=StoreVariable Path=$[?@.name=="Alice"].id Name=AliceId        | ID of Alice stored     | -             |
...
| 14       | Verify name             | Action=CheckContent Path=$.name Value=Alice                          | Name is Alice          | -             |
| 15       | Verify age              | Action=CheckContent Path=$.age Value=30                              | Age is 30              | -             |
