...
| 4       | Contains Alice          | Action=CheckContent Value=\"$[?(@.name == 'Alice')]\"     | Content contains Alice | tbd           |
| 5       | Get Alice ID            | Action=StoreVariable Value=\"$[?(@.name == 'Alice')].id\" | Returns Alice's ID     | tbd           |
