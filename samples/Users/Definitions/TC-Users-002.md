...
| 05       | Retain UserId          | Action=StoreVariable Selector=$ Name=UserId               | ID of new user     | -             |
...
| 13       | Check Tom              | Action=CheckContent Selector=$.name Value=Tom    | Content contains Tom | -             |
| 14       | Check Tom's age is 45  | Action=CheckContent Selector=$.age Value=45      | Age is 45            | -             |
