...
| -------: | ----------------------- | -------------------------------------------------------------------------------------------- | ---------------------- | ------------- |
| 01 | Prepare Tom | Action=AddContent File=../../samples/Users/Definitions/tom.json ContentType=application/json | User tom prepared | - |
...
| 13 | Contains Tom | Action=CheckContent ContentType=application/json JsonPath=$.name Value=Tom | Content contains Tom | ✅ |
| 14 | Tom's age is 45 | Action=CheckContent ContentType=application/json JsonPath=$.age Value=45 | Age is 45 | ✅ |
